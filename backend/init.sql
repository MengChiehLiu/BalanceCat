...
INSERT INTO registers (user_id, entry_id, subject_id, initial_value, book_value, expired_in, timestamp) VALUES
    (1, 4, 1103, 50, 50, null, '2023/03/01 00:00:00'),
    (1, 5, 2102, -110, -110, null, '2023/03/01 00:00:00'),
    (1, 6, 1201, 10000, 10000, 10, '2023/03/01 00:00:00'),
    (1, 7, 2201, -6000, -6000, 5, '2023/03/01 00:00:00');
...
INSERT INTO balances (user_id, subject_id, amount, month) VALUES
    (1, 1000, 6810, '2023-03-01'),
    (1, 1100, -3190, '2023-03-01'),
    (1, 1101, -3240, '2023-03-01'),
    (1, 1102, 0, '2023-03-01'),
    (1, 1103, 50, '2023-03-01'),
    (1, 1104, 0, '2023-03-01'),
    (1, 1200, 10000, '2023-03-01'),
    (1, 1201, 10000, '2023-03-01'),
    (1, 1202, 0, '2023-03-01'),
    (1, 1203, 0, '2023-03-01'),
    (1, 1204, 0, '2023-03-01'),
    (1, 1205, 0, '2023-03-01'),
    (1, 1206, 0, '2023-03-01'),
    (1, 2000, -6110, '2023-03-01'),
    (1, 2100, -110, '2023-03-01'),
    (1, 2101, 0, '2023-03-01'),
    (1, 2102, -110, '2023-03-01'),
    (1, 2103, 0, '2023-03-01'),
    (1, 2200, -6000, '2023-03-01'),
    (1, 2201, -6000, '2023-03-01'),
    (1, 2202, 0, '2023-03-01'),
    (1, 2203, 0, '2023-03-01'),
    (1, 2204, 0, '2023-03-01'),
    (1, 3000, -700, '2023-03-01'),
    (1, 3100, 0, '2023-03-01'),
    (1, 3200, -700, '2023-03-01'),
    (1, 4000, -1000, '2023-03-01'),
    (1, 4100, -1000, '2023-03-01'),
    (1, 4101, -1000, '2023-03-01'),
    (1, 4102, 0, '2023-03-01'),
    (1, 4103, 0, '2023-03-01'),
    (1, 4200, 0, '2023-03-01'),
    (1, 4201, 0, '2023-03-01'),
    (1, 4202, 0, '2023-03-01'),
    (1, 4203, 0, '2023-03-01'),
    (1, 5000, 300, '2023-03-01'),
    (1, 5100, 300, '2023-03-01'),
    (1, 5101, 100, '2023-03-01'),
    (1, 5102, 200, '2023-03-01'),
    (1, 5103, 0, '2023-03-01'),
    (1, 5104, 0, '2023-03-01'),
    (1, 5105, 0, '2023-03-01'),
    (1, 5106, 0, '2023-03-01'),
